...
parser.add_argument('--iter', help='Number of iterations of batch size',
...
def iter_train(ds: NameCategoricalDataLoader, iterations: int = ITER, path: str = "Checkpoints/",
...
ds = NameCategoricalDataLoader(df)
iter_train(ds)
